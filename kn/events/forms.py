...
def get_add_event_form(user, superuser=False):
    class AddEventForm(forms.Form):
        ...
        msg_subscribed = forms.CharField(label='E-Mail wanneer aangemeld',
            widget=forms.Textarea,
        ...
        when = forms.DateField(label='Datum')
        ...
        owner_can_subscribe_others = forms.BooleanField(required=False,
                label='Eigenaar kan iedereen inschrijven')
        anyone_can_subscribe_others = forms.BooleanField(required=False,
