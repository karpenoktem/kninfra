...
urlpatterns = patterns('',
    ...
    url(r'^studie/(?P<name>[^/]+)/$',
        views.entity_detail, {'type': 'study'}, name='study-by-studyName'),
    ...
    url(r'^instituut/(?P<name>[^/]+)/$',
        ...
        name='institute-by-instituteName'),
    ...
    url(r'^secretariaat/addinstitute$',
        views.secr_add_institute, name='secr-add-institute'),
    url(r'^secretariaat/addstudy$',
        views.secr_add_study, name='secr-add-study'),
