...
class DaanStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SetPostfixMap = channel.unary_unary(
        '/Daan/SetPostfixMap',
        request_serializer=daan__pb2.PostfixMap.SerializeToString,
        response_deserializer=daan__pb2.Empty.FromString,
        )
    ...
    self.ApplyWikiChanges = channel.unary_unary(
        ...
        request_serializer=daan__pb2.WikiChanges.SerializeToString,
        response_deserializer=daan__pb2.Empty.FromString,
        )
    self.ApplyLDAPChanges = channel.unary_unary(
        '/Daan/ApplyLDAPChanges',
        request_serializer=daan__pb2.LDAPChanges.SerializeToString,
        response_deserializer=daan__pb2.Empty.FromString,
        )
    self.SetLDAPPassword = channel.unary_unary(
        '/Daan/SetLDAPPassword',
        request_serializer=daan__pb2.LDAPNewPassword.SerializeToString,
        response_deserializer=daan__pb2.Empty.FromString,
        )
    self.FotoadminCreateEvent = channel.unary_unary(
        '/Daan/FotoadminCreateEvent',
        request_serializer=daan__pb2.FotoadminEvent.SerializeToString,
        response_deserializer=daan__pb2.Empty.FromString,
        )
    self.FotoadminMoveFotos = channel.unary_unary(
        '/Daan/FotoadminMoveFotos',
        request_serializer=daan__pb2.FotoadminMoveAction.SerializeToString,
        response_deserializer=daan__pb2.Empty.FromString,
        )
...
def add_DaanServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'SetPostfixMap': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=daan__pb2.PostfixMap.FromString,
          response_serializer=daan__pb2.Empty.SerializeToString,
      ),
