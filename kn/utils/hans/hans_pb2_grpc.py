...
class HansStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetMembership = channel.unary_unary(
        '/Hans/GetMembership',
        request_serializer=hans__pb2.GetMembershipReq.SerializeToString,
        response_deserializer=hans__pb2.GetMembershipResp.FromString,
        )
    self.ApplyChanges = channel.unary_unary(
        '/Hans/ApplyChanges',
        request_serializer=hans__pb2.ApplyChangesReq.SerializeToString,
        response_deserializer=hans__pb2.ApplyChangesResp.FromString,
        )
...
def add_HansServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetMembership': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=hans__pb2.GetMembershipReq.FromString,
          response_serializer=hans__pb2.GetMembershipResp.SerializeToString,
      ),
      'ApplyChanges': grpc.unary_unary_rpc_method_handler(
          servicer.ApplyChanges,
          request_deserializer=hans__pb2.ApplyChangesReq.FromString,
          response_serializer=hans__pb2.ApplyChangesResp.SerializeToString,
      ),
  }
