...
urlpatterns = [
    ...
    url(_(r'^bestuur15/?$'), RedirectView.as_view(
        url='/bestuur15b', permanent=False), name='bestuur15'),
    url(_(r'^bestuur15a/?$'), TemplateView.as_view(
        template_name='static/bestuur15a.html'), name='bestuur15a'),
    url(_(r'^bestuur15b/?$'), TemplateView.as_view(
        template_name='static/bestuur15b.html'), name='bestuur15b'),
    url(_(r'^bestuur16a/?$'), TemplateView.as_view(
        template_name='static/bestuur16a.html'), name='bestuur16a'),
    url(_(r'^bestuur17a/?$'), TemplateView.as_view(
    ...
    url(_(r'^bestuur20/?$'), TemplateView.as_view(
        template_name='static/bestuur20.html'), name='bestuur20'),
    url(_(r'^bestuur21a/?$'), TemplateView.as_view(
        template_name='static/bestuur21a.html'), name='bestuur21a'),
    url(_(r'^bestuur21b/?$'), TemplateView.as_view(
        template_name='static/bestuur21b.html'), name='bestuur21b'),
    url(_(r'^bestuur21c/?$'), TemplateView.as_view(
    ...
    url(_(r'^bestuur/?$'), RedirectView.as_view(
        url='/bestuur21c', permanent=False), name='bestuur'),
