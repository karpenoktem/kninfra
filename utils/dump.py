...
from kn.leden.models import OldKnUser, OldKnGroup, OldSeat, Alias, CertificateOwnership
...
if __name__ == '__main__':
	 print json.dumps(dump_all((Alias, OldSeat, Filling, CertificateOwnership),
		 	  (User, Group)))
