...
WikiChanges = _reflection.GeneratedProtocolMessageType('WikiChanges', (_message.Message,), {
...
WikiUser = _reflection.GeneratedProtocolMessageType('WikiUser', (_message.Message,), {
